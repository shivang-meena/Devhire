        ...
        <div className={`options-sidebar flex flex-col  gap-3  `}>
            ...
            <div className={`flex justify-start  gap-2 ${color==="Dashboard"&&"bg-[#0E5794]"} h-9 rounded-lg items-center ${!full?"w-11 flex-center":" w-full pl-2 "}`}>
                <div className="icon text-2xl">
                     ...
                     <Link to="/admin/dashboard" className="text-white !no-underline"> <RiDashboardLine /> </Link>
                    
                </div>
                {full&&<div className="text font-semibold text-md">
                   
                     <Link to="/admin/dashboard" className="text-white !no-underline">  Dashboard</Link>
            ...
            <div className={`flex justify-start  gap-2 ${color==="manage-users"&&"bg-[#0E5794]"} h-9 rounded-lg items-center ${!full?"w-11 flex-center":" w-full pl-2 "}`}>
          
                <div className="icon text-2xl">
                    
                     <Link to="/manageusers" className="text-white !no-underline text-3xl ">  <FaUsers/> </Link>
                    
                </div>
               {full&&<div className="text font-semibold text-md">
                   
                     <Link to="/manageusers" className="text-white !no-underline">Manage Users</Link>
                    
                </div>}
            
            </div>

     <div className={`flex justify-start  gap-2 h-9 rounded-lg  ${color==="Browse Jobs"&&"bg-[#0E5794]"} items-center ${!full?"w-11 flex-center":" w-full pl-2 "}`}>
                <div className="icon text-2xl">
                   
                     <Link to="/managejobs" className="text-white !no-underline"> < FaShoppingBag/></Link>

                </div>
                {full&&<div className="text font-semibold text-md">
                     <Link to="/managejobs" className="text-white !no-underline">Manage Jobs</Link>
                </div>}
        </div>
